...
class HailoDetectionNode(Node):
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(Image, '/camera/image_raw', self.raw_frame_callback, 10)
    ...
    def raw_frame_callback(self, msg):
        ...
        # Preprocess frame
        return self.preprocess_frame(frame, self.model_h, self.model_w, video_h, video_w)
